...
/* harmony default export */ __webpack_exports__["default"] = ("<h1>PPM - Project Product Management</h1>\n<button [routerLink]=\"['/home']\">Home</button>\n<button [routerLink]=\"['/products']\">Product List</button>\n<button [routerLink]=\"['/new']\">Product Creation</button>\n<router-outlet></router-outlet>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h3>Edit Product</h3>\n\n<div *ngIf=\"errors.name\">{{ errors.errors.title.message }}</div>\n<div *ngIf=\"errors.name\">{{ errors.errors.price.message }}</div>\n\n<form #writeForm=\"ngForm\" (submit)=\"editProduct(oneProduct._id)\">\n    <label for=\"title\">Title</label>\n    <input\n        type=\"text\"\n        name=\"title\"\n        id=\"title\"\n        [(ngModel)]=\"oneProduct.title\"\n        minlength=\"4\"\n        required\n        value={{oneProduct.title}} ><br>\n    <label for=\"price\">Price</label>\n    <input\n        type=\"text\"\n        name=\"price\"\n        id=\"price\"\n        [(ngModel)]=\"oneProduct.price\"\n        minlength=\"3\"\n        required\n        value={{oneProduct.price}}><br>\n    <label for=\"imageURL\">Image URL</label>\n    <input\n        type=\"text\"\n        name=\"imageURL\"\n        [(ngModel)]=\"oneProduct.imageURL\"\n        id=\"imageURL\"\n        value={{oneProduct.imageURL}}><br>\n    <input type=\"submit\" name=\"submit\" id=\"submit\" value=\"Update\">\n    <button (click)=\"deleteProduct(oneProduct._id)\">Delete</button>\n</form>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h3>Home Page</h3>\n<p>Welcome to Projdct Product Management! Here we can manage a set of products. You are ablt to create products, remove old products, and edit products.</p>\n");
...
module.exports = __webpack_require__(/*! /Users/aili/code/CodingDojo/mean_stack/angular_mean/Angular/ProductManager/public/src/main.ts */"./src/main.ts");
